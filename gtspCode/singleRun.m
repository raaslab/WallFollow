...
data = readData('/home/klyu/lab/WallFollow/input/bridge10.txt'); % get the size and shape from the data (this will tell you number of clusters points and so on)
...
filename2 = sprintf('/home/klyu/lab/bridge12.gtsp');
filename3 = sprintf('bridge13');

tic
pathName = '/home/klyu/lab/WallFollow/output';
