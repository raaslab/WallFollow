...
function [v_AdjNew, v_Type, sNew, tNew, weights, v_ClusterLevels, F] = makingSTWv_AdjGeneral(maxDistance, x, y, numPoints, numLevels, v_Cluster, groupedPoints,UGVCapable)
